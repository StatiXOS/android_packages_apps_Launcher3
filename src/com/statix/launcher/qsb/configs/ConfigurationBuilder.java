 ...
 */
package com.statix.launcher.qsb.configs;
...
import com.statix.launcher.CustomLauncher;
import com.statix.launcher.CustomLauncherCallbacks;
import com.statix.launcher.qsb.AllAppsQsbContainer;
import com.statix.launcher.search.nano.SearchProto.Columns;
import com.statix.launcher.search.nano.SearchProto.AppIndex;
import com.statix.launcher.search.nano.SearchProto.SearchBase;
import com.statix.launcher.search.nano.SearchProto.SearchView;
import com.statix.launcher.search.AppSearchProvider;
...
public class ConfigurationBuilder {
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(CustomLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
