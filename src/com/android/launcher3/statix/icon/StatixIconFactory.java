 ...
 */
package com.android.launcher3.statix.icon;
...
public class StatixIconFactory extends BaseIconFactory {

    private final IconPackStore mIconPackStore;

    public StatixIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
