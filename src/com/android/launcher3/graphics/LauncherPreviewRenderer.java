...
import com.android.launcher3.statix.icon.StatixIconFactory;
...
public class LauncherPreviewRenderer {
    ...
    public LauncherPreviewRenderer(Context context, InvariantDeviceProfile idp, boolean migrated) {
        ...
        StatixIconFactory iconFactory =
                new StatixIconFactory(context, mIdp.fillResIconDpi, mIdp.iconBitmapSize) { };
