...
import com.android.launcher3.qsb.AllAppsQsbContainer;
import com.android.launcher3.search.nano.SearchProto.Columns;
import com.android.launcher3.search.nano.SearchProto.AppIndex;
import com.android.launcher3.search.nano.SearchProto.SearchBase;
import com.android.launcher3.search.nano.SearchProto.SearchView;
...
public class ConfigurationBuilder {
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(LauncherTab.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
