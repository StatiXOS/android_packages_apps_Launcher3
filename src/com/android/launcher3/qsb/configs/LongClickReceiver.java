...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<Launcher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(Launcher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        Launcher launcher = (Launcher) mWeakReference.get();
        if (launcher != null) {
