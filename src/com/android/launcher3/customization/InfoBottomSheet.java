...
public class InfoBottomSheet extends WidgetsBottomSheet {
    ...
    public static class PrefsFragment extends PreferenceFragment
        ...
        public void loadForApp(ItemInfo itemInfo, final View.OnClickListener onMoreClick) {
            ...
            IconPackPreference icons = (IconPackPreference) findPreference(KEY_ICON_PACK);
            icons.setOnPreferenceChangeListener(this);
            icons.setValue(IconPackProvider.getCurrentIconPack(mContext));
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            // find a way to set an individual icon
            return true;
        }
