...
public class QuickSpaceView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener,
    ...
    private void loadSingleLine() {
        ...
        if (!mWeatherClient.isAvailable(getContext())) {
    ...
    private void queryAndUpdateWeather() {
        if (DEBUG) Log.d(TAG, "queryAndUpdateWeather.isAvailable " + mWeatherClient.isAvailable(getContext()));
        mWeatherInfo = null;
        updateWeather();
    }
